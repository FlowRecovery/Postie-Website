type PostieLogoProps = {
  /** Tailwind colour utilities, e.g. `text-charcoal`, `text-warm-white` */
  className?: string;
  heightClass?: string;
};

export function PostieLogo({ className = 'text-charcoal', heightClass = 'h-8' }: PostieLogoProps) {
  return (
    <span className={`inline-flex shrink-0 items-center ${className}`} aria-label="Postie">
      <svg
